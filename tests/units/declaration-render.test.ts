...
import { renderDeclaration } from '../../src/modules/rendering/typed-declaration'
import {
    scalar,
    typenameValue,
    unionValue,
...
describe('declaration rendering', () => {
    describe('imports and module wrapper', () => {
        ...
        test('renders operation declarations with result, variables and typed document export', () => {
            ...
            expect(result).toContain('\texport type GetUserQueryQuery = {')
    ...
    describe('object and union rendering', () => {
