...
2. Проверяет хеши ранее опубликованных файлов, если `options.force` не равен
   `true`. Всегда проверяет отсутствие чужих файлов на запланированных путях.
   Конфликт останавливает публикацию до первой записи.
...
manifest и проверку принадлежности файлов. Политика кеша схемы не меняется.
